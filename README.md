...
Make sure the development version of Open Scad is installed as it has needed options for exporting.

If first time set the source and destination directories. 
